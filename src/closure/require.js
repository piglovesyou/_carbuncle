...
goog.exportSymbol('goog.style.getFramedPageOffset', goog.style.getFramedPageOffset);
goog.exportSymbol('goog.style.getBorderBoxSize', goog.style.getBorderBoxSize);
goog.exportSymbol('goog.style.installStyles', goog.style.installStyles);
goog.exportSymbol('goog.style.uninstallStyles', goog.style.uninstallStyles);
