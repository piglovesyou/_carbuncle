...
describe('carbuncle.js', function() {
  ...
  describe('Passing Executor', function() {
    ...
    it('should pass', function(done) {
      ...
      var seed = {
        ...
        entries: [
          {title: 'open website', mode: 'action', type: 'open', text: 'http://www.yahoo.co.jp/'},
          {title: 'input search text', mode: 'action', type: 'input', css: 'input#srchtxt', text: 'ゴミメガネ' + webdriver.Key.ENTER},
          {title: 'click search button', mode: 'action', type: 'input', css: '#srchbtn'},
          {title: 'verify whether any item was loaded', mode: 'verify', type: 'contains', css: '#mIn', text: '本間'}
        ]
      };
  ...
  //       entries: [
  //         {title: 'open website', mode: 'action', type: 'open', text: 'http://www.yahoo.co.jp/'},
  //         {title: 'input search text', mode: 'action', type: 'input', css: 'input#srchtxt', text: 'm' + webdriver.Key.ENTER},
  //         {title: 'verify whether any item was loaded', mode: 'verify', type: 'contains', css: '#mIn', text: '本間'}
  //       ]
  //     };
  //     var executor = new Executor(seed.entries);
